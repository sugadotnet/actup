...
namespace APPBASE.Controllers
{
    ...
    {
        [HttpPost]
        public ActionResult Create(Audit_DetailVM poViewModel)
        {

            oVAL = new Audit_Validation(poViewModel);
        ...
        [HttpPost]
        public ActionResult Edit(Audit_DetailVM poViewModel)
        {
            oVAL = new Audit_Validation(poViewModel);
            oVAL.Validate_Edit();
        ...
        public ActionResult DeleteConfirmed(string id)
        {
            ...
            oVAL = new Audit_Validation(oViewModel);
