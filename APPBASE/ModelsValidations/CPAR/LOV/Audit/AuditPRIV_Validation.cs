    ...
    public partial class Audit_Validation
    {
        ...
        private void Validate_LOV_NM()
        {
            ...
            if ((oViewModel.LOV_NM == "") || (oViewModel.LOV_NM == null))
            {
                ...
                oMSG.VAL_ERRMSG = "Nama Proses Audit harus diisi";
                aValidationMSG.Add(oMSG);
            } //End if
            //[LOV_NM] - Maxlength
            if ((oViewModel.LOV_NM != "") && (oViewModel.LOV_NM != null))
        ...
        private void Validate_DEPT_RUID()
        {
            Boolean bIsvalid = true;
            //[LOV_NM] - Required
            if ((oViewModel.DEPT_RUID == "") || (oViewModel.DEPT_RUID == null))
            {
                bIsvalid = false;
                ValidationMSG_VM oMSG = new ValidationMSG_VM();
                oMSG.VAL_ERRID = "DEPT_RUID1";
                oMSG.VAL_ERRMSG = "Departemen harus diisi";
                aValidationMSG.Add(oMSG);
            } //End if
        ...
        } //End private void Validate_DEPT_RUID()

        private void Validate_DELETE()
        {
            Boolean bIsvalid = true;
            //[ISUSEDBY_RES] - Inuse
            if (oDS.isUSEDBY_CPAR(oViewModel.RUID))
            {
                bIsvalid = false;
                ValidationMSG_VM oMSG = new ValidationMSG_VM();
                oMSG.VAL_ERRID = "DELETE1";
                oMSG.VAL_ERRMSG = "Sudah digunakan oleh beberapa CPAR";
                aValidationMSG.Add(oMSG);
            } //End if
