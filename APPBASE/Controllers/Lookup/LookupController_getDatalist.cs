...
namespace APPBASE.Controllers
{
    ...
    {
        public ActionResult ShowRole_getDatalist(List<string> paSearchValue, List<string> paTargetTag)
        {
            //Tag to Target
            ...
            return View(oDSRole.getDatalist(hlpConfig.SessionInfo.getAppMdleRUID()));
        } //End public ActionResult ShowRole_getDatalist
